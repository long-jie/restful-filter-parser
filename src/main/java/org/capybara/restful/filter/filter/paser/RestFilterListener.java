...
public interface RestFilterListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterLogicExpr(RestFilterParser.LogicExprContext ctx);
	/**
	 * Exit a parse tree produced by the {@code LogicExpr}
	 * labeled alternative in {@link RestFilterParser#expr}.
	 * @param ctx the parse tree
	 */
	void exitLogicExpr(RestFilterParser.LogicExprContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link RestFilterParser#logicOperator}.
	 * @param ctx the parse tree
	 */
	void enterLogicOperator(RestFilterParser.LogicOperatorContext ctx);
	/**
	 * Exit a parse tree produced by {@link RestFilterParser#logicOperator}.
	 * @param ctx the parse tree
	 */
	void exitLogicOperator(RestFilterParser.LogicOperatorContext ctx);
}